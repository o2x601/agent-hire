...
export default async function DeveloperSettingsPage() {
  ...
  if (role === "company") redirect("/dashboard/company/settings");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={row}>
          <span style={label}>スカウト受信通知</span>
          <span style={{ ...value, color: "#9ca3af" }}>未設定</span>
        </div>
        <div style={row}>
          <span style={label}>面接通知</span>
          <span style={{ ...value, color: "#9ca3af" }}>未設定</span>
        </div>
        <div style={{ ...row, borderBottom: "none" }}>
          <span style={label}>採用通知</span>
          <span style={{ ...value, color: "#9ca3af" }}>未設定</span>
        </div>
      </div>
    </div>
